...
def download_judgment(uri, filename):
    ...
    endpoint = f"{base_url}/{uri}/data.pdf"
...
def generate_data(json_path):
    ...
    directory = "./data/pdf_data"  # Replace with your desired directory path
    ...
    for title, citation ,page,url in zip(judgment_titles, neutral_citations,pages,urls):
        ...
        file_name=title+".pdf"
        location="./data/pdf_data/pdf_page_"+str(page)+"/"
